      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {(lowStockCount > 0 || outOfStockCount > 0) && (
          <div className="mt-4 flex flex-wrap gap-3">
            {outOfStockCount > 0 && (
              <div className="flex items-center gap-2 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 px-4 py-2 rounded-lg text-sm">
                <AlertTriangle size={16} aria-hidden="true" />
                {outOfStockCount} product{outOfStockCount > 1 ? 's' : ''} out of stock
              </div>
            )}
            {lowStockCount > 0 && (
              <div className="flex items-center gap-2 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-800 text-amber-700 dark:text-amber-400 px-4 py-2 rounded-lg text-sm">
                <AlertTriangle size={16} aria-hidden="true" />
